...
// provider: postgres
// protoc-gen-structify: (version=v1.0.7, branch=main, revision=6e9539759b2a47bbc89ae7f538adf82bd034e2d6), build: (go=go1.21.3, date=2023-10-18T20:37:45+0300)
// protoc: 3.15.8
package db
...
type DeviceStorage interface {
	...
	// Lock locks the Device for filtering rows.
...
// Lock locks the Device for the given ID.
...
type PostStorage interface {
	...
	Count(ctx context.Context, builders ...*QueryBuilder) (int64, error)
	// Lock locks the Post for filtering rows.
	LockForUpdate(ctx context.Context, builders ...*QueryBuilder) error
...
// Lock locks the Post for the given ID.
...
type UserStorage interface {
	...
	Count(ctx context.Context, builders ...*QueryBuilder) (int64, error)
	// Lock locks the User for filtering rows.
	LockForUpdate(ctx context.Context, builders ...*QueryBuilder) error
...
// Lock locks the User for the given ID.
...
type SettingStorage interface {
	...
	Count(ctx context.Context, builders ...*QueryBuilder) (int64, error)
	// Lock locks the Setting for filtering rows.
	LockForUpdate(ctx context.Context, builders ...*QueryBuilder) error
...
// Lock locks the Setting for the given ID.
...
type AddressStorage interface {
	...
	Count(ctx context.Context, builders ...*QueryBuilder) (int64, error)
	// Lock locks the Address for filtering rows.
	LockForUpdate(ctx context.Context, builders ...*QueryBuilder) error
...
// Lock locks the Address for the given ID.
