...
// provider: postgres
// protoc-gen-structify: (version=v1.1.27, branch=main, revision=7517048732f0f0de5824b61d5486f3ae9392cc76), build: (go=go1.23.6, date=2025-10-04T15:08:56+0400)
// protoc: 3.16.0
package db
...
func (m *PostTagsRepeated) Scan(src interface{}) error {
	...
	default:
		return fmt.Errorf("cannot scan %T into PostTagsRepeated", src)
	}
}
