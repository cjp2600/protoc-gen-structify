...
// provider: postgres
// protoc-gen-structify: (version=v1.0.0-33-gaa3b1a2, branch=main, revision=aa3b1a2823cba9fe3507b63b01d52f3a5fee5cf1), build: (go=go1.20.7, date=2023-08-18T11:50:26+0300)
// protoc: 3.15.8
package db
...
func (t *userStorage) FindById(ctx context.Context, id string, opts ...Option) (*User, error) {
	model, err := t.FindOne(ctx, NewQueryBuilder().WithFilter(UserIdEq(id)))
	if err != nil {
...
func (t *settingStorage) FindById(ctx context.Context, id int32, opts ...Option) (*Setting, error) {
	model, err := t.FindOne(ctx, NewQueryBuilder().WithFilter(SettingIdEq(id)))
	if err != nil {
		if err == sql.ErrNoRows {
			return nil, ErrRowNotFound
		}
...
func (t *settingStorage) FindOne(ctx context.Context, builders ...*QueryBuilder) (*Setting, error) {
	...
	if len(results) == 0 {
		return nil, fmt.Errorf("no Setting found")
	}
...
func (t *addressStorage) FindById(ctx context.Context, id string, opts ...Option) (*Address, error) {
	model, err := t.FindOne(ctx, NewQueryBuilder().WithFilter(AddressIdEq(id)))
	if err != nil {
		if err == sql.ErrNoRows {
			return nil, ErrRowNotFound
		}
