...
// provider: postgres
// protoc-gen-structify: (version=v1.0.0-32-g7dc6b7c, branch=main, revision=7dc6b7ce7d2cbd186358af9ff381d0b916028012), build: (go=go1.20.7, date=2023-08-17T15:58:36+0300)
// protoc: 3.15.8
package db
...
type UserStorage interface {
	...
	GetById(ctx context.Context, id string, opts ...Option) (*User, error)
...
// GetById retrieves a User by its id.
func (t *userStorage) GetById(ctx context.Context, id string, opts ...Option) (*User, error) {
	// set default options
	options := &Options{}
	for _, o := range opts {
		o(options)
	...
	query := t.queryBuilder.Select(t.Columns()...).From(t.TableName()).Where("id = ?", id)
...
type SettingStorage interface {
	...
	GetById(ctx context.Context, id int32, opts ...Option) (*Setting, error)
...
// GetById retrieves a Setting by its id.
func (t *settingStorage) GetById(ctx context.Context, id int32, opts ...Option) (*Setting, error) {
	// set default options
	options := &Options{}
	for _, o := range opts {
		o(options)
...
type AddressStorage interface {
	...
	GetById(ctx context.Context, id string, opts ...Option) (*Address, error)
...
// GetById retrieves a Address by its id.
func (t *addressStorage) GetById(ctx context.Context, id string, opts ...Option) (*Address, error) {
	// set default options
	options := &Options{}
	for _, o := range opts {
		o(options)
