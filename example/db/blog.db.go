...
// provider: postgres
// protoc-gen-structify: (version=v1.0.0-35-gd10f102, branch=main, revision=d10f102f208690c8d91aba7c32710542fba91616), build: (go=go1.20.7, date=2023-08-18T13:57:15+0300)
// protoc: 3.15.8
package db
...
func (t *deviceStorage) Count(ctx context.Context, builders ...*QueryBuilder) (int64, error) {
	...
	for _, builder := range builders {
		...
		// Pagination and sorting are typically not applied in a count query
	}
