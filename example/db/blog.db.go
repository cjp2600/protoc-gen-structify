...
// provider: postgres
// protoc-gen-structify: (version=v1.0.0-30-g98b08c6, branch=main, revision=98b08c60e230dcf282a145ebca808698fd4ac585), build: (go=go1.20.7, date=2023-08-16T16:37:15+0300)
// protoc: 3.15.8
package db
...
type DeviceStorage interface {
	...
	// Delete removes an existing Device by its ID.
...
// Delete removes an existing Device by its ID.
func (t *deviceStorage) Delete(ctx context.Context, id int64) error {
	query := t.queryBuilder.Delete("devices").Where("id = ?", id)
...
// Delete removes an existing User by its ID.
func (t *userStorage) Delete(ctx context.Context, id string) error {
...
// GetById retrieves a User by its id.
func (t *userStorage) GetById(ctx context.Context, id string) (*User, error) {
...
type SettingStorage interface {
	...
	GetById(ctx context.Context, id int32) (*Setting, error)
}
...
// Delete removes an existing Setting by its ID.
func (t *settingStorage) Delete(ctx context.Context, id int32) error {
...
// GetById retrieves a Setting by its id.
func (t *settingStorage) GetById(ctx context.Context, id int32) (*Setting, error) {
	query := t.queryBuilder.Select(
		"id",
		"name",
		"value",
...
type AddressStorage interface {
	...
	Delete(ctx context.Context, id string) error
	// GetById retrieves a Address by its id.
...
// Delete removes an existing Address by its ID.
func (t *addressStorage) Delete(ctx context.Context, id string) error {
...
// GetById retrieves a Address by its id.
func (t *addressStorage) GetById(ctx context.Context, id string) (*Address, error) {
	query := t.queryBuilder.Select(
		"id",
		"street",
		"city",
